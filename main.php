...
<body>
<div class="cont-all">
    <!-- <div id='test'>blla</div> -->
    <div id="carouselExampleSlidesOnly" class="carousel slide reldiv" data-ride="carousel" data-interval="5000"
         data-pause="false">
        <div class="absdiv">
            ...
            <div class="d-flex flextop2 justify-content-between">
                <div class="footer-item">
                    <div class="contDiv">

                        <a href="mailto:contact@armhero.org?Subject=Subject" id='mailTo'>
            ...
            <span class="footerspan">
              <?php
              if ($lang_menu == "am") {
                  echo "Նախագծում և պատրաստում  <a href='https://www.cybertech.am/'>«CyberTech»</a> ընկերություն։ </span> <i class='far fa-copyright'></i> «Սթարթափ Կենտրոն» ՀԿ, " . date("Y");
              }
              if ($lang_menu == "en") {
