...
$article_table='autobiography_articles_'.$lang_dir ;
// echo $article_table;

$sql = "SELECT * FROM $article_table INNER JOIN users ON $article_table.user_id = users.id INNER JOIN autobiography_images ON $article_table.article_id = autobiography_images.article_id WHERE $article_table.article_id='$article_id'";
$result = mysqli_query($con, $sql);
$row_auth = mysqli_fetch_assoc($result);

$sql_edited_articles="SELECT * FROM $article_table INNER JOIN autobiography_edited_articles_by_users INNER JOIN users ON $article_table.article_id= autobiography_edited_articles_by_users.article_id AND users.id=autobiography_edited_articles_by_users.user_id WHERE $article_table.article_id='$article_id' and autobiography_edited_articles_by_users.article_status = '1'";
$result_edited_articles = $con->query($sql_edited_articles); 


$sql_ext_links="SELECT * FROM $article_table INNER JOIN autobiography_external_links ON $article_table.article_id= autobiography_external_links.article_id WHERE $article_table.article_id='$article_id'";
$result_ext_links = $con->query($sql_ext_links);  

$sql_int_links="SELECT * FROM $article_table INNER JOIN autobiography_internal_links ON $article_table.article_id= autobiography_internal_links.article_id WHERE $article_table.article_id='$article_id'";
...
// $sql_comment = "SELECT a.article_id, a.created_date, a.description, a.user_id, c.* FROM $comment_table a, users c WHERE a.user_id = c.id AND a.status = 1 AND a.article_id = $sel_art_id";
// $res_com = $con->query($sql_comment);

// Additional Authors

   
// $sql_edites_authors = "SELECT a.user_id, a.article_id, c.* FROM $article_table a, users c WHERE a.user_id = c.id AND a.article_status = 2 AND a.article_id = $article_id GROUP BY a.user_id";

// $res_author = mysqli_query($con, $sql_edites_authors);
...
// }
    ...
    if(!$row_data_views['number_of_views']){
        ...
        $sql_views=mysqli_query($con, "UPDATE autobiography_articles_am SET number_of_views=".$ins_number_of_views." WHERE autobiography_articles_am.article_id='$article_id'");
        $sql_views=mysqli_query($con, "UPDATE autobiography_articles_en SET number_of_views=".$ins_number_of_views." WHERE autobiography_articles_en.article_id='$article_id'");
        $sql_views=mysqli_query($con, "UPDATE autobiography_articles_ru SET number_of_views=".$ins_number_of_views." WHERE autobiography_articles_ru.article_id='$article_id'");
    ...
    // images
    $sql_main_image = mysqli_query($con, "SELECT image from autobiography_images WHERE article_id='$article_id' and main='1'");
    $row_main_image=mysqli_fetch_assoc($sql_main_image );
    // echo $row_main_image['image'];

    $sql_images =  "SELECT image from autobiography_images WHERE article_id='$article_id' and main='0'";
    
    $sql_images_result = mysqli_query($con, $sql_images);
    $sql_images2 =  "SELECT image from autobiography_images WHERE article_id='$article_id' and main='0'";
    
    $sql_images_result2 = mysqli_query($con, $sql_images2);
// print_r($sql_images[0]);
    
    $sql_most_read = "SELECT a.article_id, a.name, a.description, a.created_date, i.image, u.fullname_am, u.fullname_ru, u.fullname_en FROM $article_table a INNER JOIN autobiography_images i ON a.article_id = i.article_id INNER JOIN users u ON a.user_id = u.id WHERE i.main = 1 AND a.article_status = 1 order by number_of_views DESC limit 10";
    $result_most_read = mysqli_query($con, $sql_most_read);


    $sql_recently_added = "SELECT a.article_id, a.name, a.description, a.created_date, i.image, u.fullname_am, u.fullname_ru, u.fullname_en FROM $article_table a INNER JOIN autobiography_images i ON a.article_id = i.article_id INNER JOIN users u ON a.user_id = u.id WHERE i.main = 1 AND a.article_status = 1 order by DATE(a.created_date) DESC limit 3";
...
<body>
    <input type="hidden" value="<?php echo $article_id; ?>" id="sel_article_id">
        <input type="hidden" value="autobiography" id="article_type">
            ...
            <div class="mainFlex-article d-flex">
                <div class="mainFlex-article-item1">
                    <div class="article-main-image-div">
                        <img src="../autobiography-articles-images/<?php echo $article_id; ?>/<?php echo $row_main_image['image']; ?>" alt="" class="article-main-image">
                    </div>
                    ...
                    <div class="images_container d-flex">
                       ...
                       ?>
                       <div data-toggle="modal" data-target="#myModal" class="images_rest_item" style="background-image: url('../autobiography-articles-images/<?php echo $article_id . "/" . $sql_images['image'] ?>');">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="carousel-item">
                           <img class="d-block w-100" src="../autobiography-articles-images/<?php echo $article_id."/".$sql_images2['image'] ?>">
                        </div>
                        <?php
                            }
                        }
...
<!-- test -->
                    ...
                    <div class="dropdown share-abs">
                        ...
                        <ul class="dropdown-menu dropdown-menu2" style="box-shadow:none">
                            <li> 
                                <a href="https://www.facebook.com/sharer/sharer.php?app_id=1204128296666901&sdk=joey&u=https://www.armhero.org/<?php echo $lang_dir;?>/auth-article-read.php?code=<?php echo $article_id;?>"
                                onclick="return !window.open(this.href, 'Facebook', 'width=620,height=420')"><img src="../Icons/facebook.png" class="soc-icon"></img></a>
                            </li>
                            <li>
                                <a href="#" onclick="window.open('http://twitter.com/share?url=https://www.armhero.org/<?php echo $lang_dir;?>/auth-article-read.php?code=<?php echo $article_id;?>?&via=armhero&text=about Armenian hero', 'Twitter Share', 'width=620, height=420'); return false;">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/shareArticle?mini=true&url=https://armhero.org/<?php echo $lang_dir;?>/auth-article-read.php?code<?php echo '%3D'.$article_id?>&title=Read artiucle about Armenian hero&summary=chillyfacts.com&source=Chillyfacts" onclick="window.open(this.href, 'mywin',
'left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); return false;" >
                                <img src="../Icons/in.png" class="soc-icon"></img>
                            </a>
                            </li>
                            <li>
                                <a href="#" onclick="window.open('http://vk.com/share.php?url=http://www.armhero.org/<?php echo $lang_dir;?>/auth-article-read.php?code=<?php echo $article_id;?>&title=Armenian hero&summary=armhero.org&source=ArmenianHeroes', 'VK Share', 'width=620, height=420'); return false;">
                    ...
                    ?>
                        <div class="last-article d-flex">
                            <div class="last-article-item1">
                                <img class="last-article-item1-img" src='../autobiography-articles-images/<?php echo $sql_recently_added['article_id']; ?>/<?php echo $sql_recently_added['image'];?>'>
                            </div>
                            <div class="last-article-item2">
                                <div class="last-article-item2-caption">
                                    <?php echo $sql_recently_added['name']; ?>
                                </div>
                                ...
                                <a  style="text-decoration:none!" class='no_dec' href='auth-article-read.php?code=<?php echo $sql_recently_added['article_id']; ?>'> 
                                <?php
                                            if ($lang_dir == "am") {
                                                echo "Կարդալ";
                                            }
