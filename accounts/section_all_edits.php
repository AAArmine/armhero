...
INNER JOIN ".$auth_table." AS b ON b.article_id=a.article_id WHERE i.main = 1 and a.article_id=i.article_id and b.user_id ='$user_id'";
...
WHERE i.main = 1 and b.user_id ='$user_id'";
