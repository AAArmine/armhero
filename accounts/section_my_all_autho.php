 <?php
                    ...
                    $sql_auth="SELECT * FROM $auth_table INNER JOIN autobiography_images on $auth_table.article_id= autobiography_images.article_id WHERE autobiography_images.main = 1 and $auth_table.user_id ='$user_id'";
