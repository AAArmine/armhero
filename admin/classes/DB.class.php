...
class DB{
    ...
    // public  $tblName     = "";
    private $dbHost   = "localhost";
    private $dbName  = "armhero";
    private $dbUsername  = "armhero";
    private $dbPassword = "urljTKNueh1SqX2G";
    public  $tblName     = "";
        ...
        if(!empty($data) && is_array($data)){
            ...
            $query = "INSERT INTO " . $this->tblName . " (" . $columns . ") VALUES (" . $values . ")";
               $insert = $this->db->query($query);
                ...
                $query1 = "INSERT INTO history_articles_am (" . $columns . ") VALUES (" . $values . ")";
                $insert1 = $this->db->query($query1);
                $query2 = "INSERT INTO history_articles_ru (" . $columns . ") VALUES (" . $values . ")";
                $insert2 = $this->db->query($query2);
                $query3 = "INSERT INTO history_articles_en (" . $columns . ") VALUES (" . $values . ")";
