                                        ...
                                        <table id="datatables" data-name="default" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody id="sortable">
                                                    ...
                                                    $mod='';
                                                       ...
                                                       $res=$db->checkRowEditedArticles($article_name, $tblname, $mod_id);
                                                       if($res){
                                                          while($row=mysqli_fetch_assoc($res)){
                                                            ...
                                                            $status = $row['article_status']==0 ? 'Նոր' : (($row['article_status']==1) ? 'Ընդունված' : 'Մերժված');
                                                            $status_class = $row['article_status']==0 ? 'text-primary' : (($row['article_status']==1) ? 'text-success' : 'text-danger');
