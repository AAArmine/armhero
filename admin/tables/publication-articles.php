<?php include "../heder.php"; ?>
    <body>
        ...
        ?>
                                    ...
                                    <div class="fresh-datatables">
                                        ...
                                        <table id="datatables" data-name="default" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                    ...
                                                    <th data-field="updated-date">Հրապարակման ամսաթիվ</th>
                                            ...
                                            <tbody id="sortable">
                                                    ...
                                                    $mod='';
                                                       ...
                                                       $res=$db->checkRowPublicationArticlesInAllLanguageTables($article_name, $categories, $mod_id);
                                                       if($res){
                                                          while($row=mysqli_fetch_assoc($res)){
                                                            ...
                                                            $count++;
                                                              ...
                                                              echo " <tr data-id=".$row['article_id'].">
                                                                         ...
                                                                         <td class='text-right'>
                                                                             <button class='btn btn-danger publish-an-article' data-type='deactive' data-id='".$row['article_id']."'>Ապահրապարակել</button>
                                                                             <a href='../tables/edit-article.php?categories-article=".$categories."&article-id=".$row['article_id']."' class='btn btn-warning edit a_edit' name=".$row['article_id']."><i class='fa fa-external-link'></i></a>
                                                                         </td>
                                                                     </tr>";
                                                            }
                                                          }
            ...
            <script src="../js/for-all.js"> </script>
</body>
</html>