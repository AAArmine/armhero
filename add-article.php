...
<section class="add-article-section py-5">
    ...
    <div class="container ">
        <form class="add-article d-flex flex-wrap mt-5 pt-4" method="post" enctype="multipart/form-data" id="a-a">
            <div class="left">
                <h4 class="fw-700"><?= HERO ?></h4>
                <hr width="20%" class="bg-red" size="3">
            ...
            <div class="d-flex flex-column right pl-5">
                <input type="text" name="name_hero" placeholder="<?= PLC_NAME ?>" data-error-text='<?= ERROR_NAME ?>'
                       class='name'>
                <input type="text" name="name_nik" placeholder="<?= PLC_NIK ?>">
                <input type="text" name="place_of_birth" placeholder="<?= PLC_PLACE_OF_BIRTH ?>">
                <input type="date" name="birth_day" class="date" placeholder="<?= PLC_DATE ?>" required>
                <input type="" name="lng" data-lng="<?= $lang_menu ?>" class="hidden" value="<?= $lang_menu ?>">
                <input type="" name="tblname" class="hidden" value="autobiography">
                <div class="mt-5">
            ...
            <div class="w-100 my-5 bottom">
                <h4 class="fw-700"><?= TITLE_DESC ?></h4>
                <hr width="14%" class="bg-red">
